...
<template>
  <VFooter class="px-0 footer">
    <VRow class="h-100" justify="center" align="end" no-gutters>
      <VCol cols="4" class="d-flex align-end">
        <img :src="Logo" alt="Logo" width="120" class="rounded-md" />
      </VCol>
