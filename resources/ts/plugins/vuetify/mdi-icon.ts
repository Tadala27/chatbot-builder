...
export const icons = {
  ...
  functionVariant: mdiFunctionVariant,
  xml: mdiXml,
  ...
  cursorDefaultClick: mdiCursorDefaultClick,
  cursorDefaultClickOutline: mdiCursorDefaultClickOutline,
  sourceBranchPlus: mdiSourceBranchPlus,
