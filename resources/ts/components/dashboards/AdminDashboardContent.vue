...
<template>
  <!-- Single root: the multi-root template (header div + loading div +
       VAlert + template all as siblings, with no shared wrapper) was the
       bug that caused the distorted/overlapping render in the screenshot —
       Vue had nowhere consistent to anchor spacing/positioning context. -->
  <div>
    <!-- ── Header ─────────────────────────────────────────────────────── -->
