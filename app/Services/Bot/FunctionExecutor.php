...
class FunctionExecutor
{
     ...
     */
    public function execute(string $functionId, array $parameters)
    {
    ...
    private function validateJavaScriptCode(string $code): void
    {
        ...
        if (!preg_match('/\bfunction\s+execute\s*\(/', $code)
            ...
            throw new \Exception('JavaScript code must define a function named "execute(params)". Example: function execute(params) { return params.a + params.b; }');
        }
    }
