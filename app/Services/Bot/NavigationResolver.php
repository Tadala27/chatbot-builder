...
class NavigationResolver
{
    ...
    public function findDialogOwningSelection(BotVersion $version, string $selectionId): ?Dialog
    {
    ...
    public function findDialogByConfigId(BotVersion $version, string $configId): ?Dialog
    {
